  ...
  return (
    <div className="w-full md:h-[81vh] relative">
      ...
      <div className="space-y-3">
        ...
        <Button variant={theme === "dark" ? "white" : "black"} className="h-[40px] mt-3 w-full flex items-center justify-center gap-2">
       <PlusIcon className="w-4 h-4" /> <p className="font-satoshi-medium">Add Another Account</p>
      </Button>
      </div>
