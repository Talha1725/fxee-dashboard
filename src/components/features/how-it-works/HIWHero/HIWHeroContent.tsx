...
export default function HIWHeroContent() {
  return (
    <LandingMax1440Container className="gradient-white-border h-fit pb-2 md:pb-20 overflow-hidden">
      <div className="flex flex-col items-center gap-10 flex-[1_0_0] self-stretch pt-12.5 pb-12.5 lg:pt-25 lg:pb-0">
        <motion.div className="flex flex-col items-center gap-5" {...fadeInUp}>
          <LandingTitle className="text-center text-[64px] leading-[100%] lg:w-[900px]">
            Trade Smarter.
            Simulate Faster.
            Scale Easier.
          </LandingTitle>
          <LandingDescription className="w-full max-w-[620px] !text-white/50 text-center">
        ...
        <motion.div
          className="relative flex items-center gap-10 sm:gap-15 h-[35px] sm:h-[156px]"
          {...createFadeIn(0.5)}
        >
          ...
          <IconLogo4
            className="w-[67px] sm:w-[120px] h-[87px] sm:h-[156px] multi-dropshadow"
            opacity={0.2}
          />
