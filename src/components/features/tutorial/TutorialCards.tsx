...
// }) => {
//   return (
//     <div className="w-[1000px] h-[364px] flex flex-col lg:flex-row rounded-2xl overflow-hidden">
//       {/* Content Section */}
//       <div className="flex-1 flex flex-col justify-between gap-5 p-5 bg-transparent relative">
//         <div className="flex flex-col gap-2.5">
//           <h3 className="text-[22px] font-satoshi-bold text-black leading-tight">
//             {heading}
//           </h3>
//           <p className="text-[18px] leading-relaxed dark:text-white/50 text-black/50 font-satoshi-regular">
//             {description}
//           </p>
//         </div>
...
//               style={{
//                 background: "radial-gradient(circle at center, rgba(2,118,219,0.6), rgba(62,220,129,0.4), transparent 70%)",
//                 filter: "blur(40px)",
//                 opacity: 1,
//               }}
//             />
...
//       description:
//         "Review AI-generated trade ideas and match them with your preferences. Let the AI align trades with current market conditions and your strategy.",
//       image: "05.svg",
//     },
//     {
//       number: "06",
...
//       description:
//         "Launch trades with one click and let the AI monitor, manage, and optimize them for you—freeing you to explore additional tools.",
//       image: "06.svg",
//     },
//     {
//       number: "07",
...
//       description:
//         "Measure your performance, learn from outcomes, and continually improve your strategy as you dive deeper into PXEE’s future-focused trading tech.",
//       image: "07.svg",
//     },
//   ];

//   return (
//     <div className="w-full px-[60px] pt-[40px] pb-[40px] flex flex-col items-center">
