...
export default function LandingHeroText() {
  return (
    <motion.div
      {...fadeInUp}
      className="flex flex-col items-center 2xl:items-start gap-5 flex-[1_0_0] self-stretch pt-12.5 pb-0 2xl:py-12.5"
    >
      <LandingTitle className="2xl:text-start text-center text-[64px] sm:text-[80px] lg:text-[124px] lg:tracking-[-6.169px] leading-[100%]">
        AI Meets Trading.
        <br />
        Redefined.
      </LandingTitle>
      <LandingDescription className="w-full max-w-[460px] text-white text-center 2xl:text-start">
