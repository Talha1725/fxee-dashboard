...
export default function LandingReviewCarouselSlide({
  ...
  return (
    <div className="transform-gpu flex flex-col gap-5 justify-center items-center w-full max-w-[80vw] sm:max-w-[798px] mx-auto p-5 py-10 xl:py-[50px] xl:p-[50px] self-stretch bg-landing-review-gradient border-landing-review-gradient">
