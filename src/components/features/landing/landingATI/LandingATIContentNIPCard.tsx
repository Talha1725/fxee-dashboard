...
import LandingATCContentNIPCard from "@/components/features/landing/landingATC/LandingATCContentNIPBadge";
import {
  IconAsteroid,
  IconAIBrain,
  IconTime,
...
export default function LandingATIContentNIPCard() {
  return (
    <LandingATICardContainer className="absolute right-[35px] top-0 w-[312px] p-[15px] gap-3 bg-green-radial-gradient border-green-gradient border-none">
      <p className="text-white liga text-[14px] font-regular font-medium tracking-[-0.155px] self-stretch z-1">
      ...
      <div className="flex items-start gap-2 self-stretch z-1">
        ...
        <div className="flex flex-col items-start gap-2 flex-[1_0_0]">
          <div className="flex justify-between items-center self-stretch h-[30px]">
            <p className="text-white text-[14px] font-regular font-[700]">
              BTC/USDT
            </p>
            <p className="text-white/80 text-[10px] font-regular font-medium uppercase">
              14:03, 15 Nov
            </p>
          </div>
          ...
          <div className="text-white text-[12px] font-regular font-normal">
          ...
          <p className="text-white text-[12px] font-regular font-medium">
          ...
          <div className="flex items-center justify-between self-stretch p-1 pl-3.5 rounded-[8px] bg-card-weak-gradient border border-white/8">
            <p className="text-white text-[12px] font-regular font-[700] tracking-[-0.246px]">
              Not fully priced-in
            </p>
            <Button
              variant="danger"
            ...
            >
              <p className="text-white text-[12px] liga font-regular font-[700] tracking-[-0.074px]">
                Short
              </p>
