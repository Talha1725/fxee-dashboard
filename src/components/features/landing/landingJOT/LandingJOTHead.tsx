...
export default function LandingJOTHead() {
  return (
    <div className="flex flex-col items-center self-stretch gap-5">
      <LandingTitle className="w-full text-center text-[44px] !tracking-[-1.76px] leading-[120%]">
        Stay Ahead of the Markets with Real-Time Insights
      </LandingTitle>
      <LandingDescription className="!text-white/50 text-center text-[16px] sm:text-[18px] tracking-[-0.36px] leading-[150%]">
