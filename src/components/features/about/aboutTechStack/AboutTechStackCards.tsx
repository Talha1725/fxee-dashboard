    ...
    <div className="flex justify-center items-center gap-5 sm:gap-10 self-stretch">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 self-stretch">
        <AboutTechStackCard
          ...
          children={
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 flex justify-center w-[80%] md:translate-y-10 translate-y-0">
        ...
        <AboutTechStackCard
          ...
          children={
              <Image src={PatternDetection} alt="About Tech Stack" className="w-[350px] md:w-[100%] translate-x-10" />
          }
        />
        <AboutTechStackCard
          title="Live Overlays"
        ...
        <AboutTechStackCard
          ...
          children={
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 flex justify-center w-[80%]">
              <Image src={Planner} alt="About Tech Stack" className="w-full object-cover" />
            </div>
