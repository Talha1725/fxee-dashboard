...
export default function ProtectedContainer({
  ...
  return (
    <div className="flex flex-col flex-[1_0_0] self-stretch overflow-x-hidden">
      ...
      <div className={`flex flex-col items-start shrink-0 gap-5 self-stretch flex-[1_0_0] p-3 xs:p-5 sm:p-6 rounded-[20px] border  dark:border-white/4  backdrop-blur-[7px] xl:mt-0 mt-16 sm:mt-21 ${location === "/copy-trading" ? "bg-[#ecf3f8] dark:bg-background border-transparent" : location === "/performance-history"? "dark:border-black/4 bg-white md:bg-[#ecf3f8] dark:bg-white/2 border-black/4 sm:border-transparent" : "bg-white/50 dark:bg-white/2 border-black/4"}`}>
