...
import { IconAIMagic, IconLock } from "@/components/ui/icon";
...
export default function HomePortfolio() {
  ...
  return (
    <ProtectedCardContainer
      className={cn(
        ` !p-0 w-full db:max-w-[397px] bg-white dark:bg-gradient-to-b from-[#F5F5F5] to-[#F5F5F5] dark:from-[#1A1A1A] dark:to-[#1A1A1A] shadow-subtle !pb-2 relative ${isVirtualAccount ? "border-none pointer-events-none shadow-xl" : ""}`,
      )}
    >
      {isVirtualAccount && (
       <BlurOverlay />
