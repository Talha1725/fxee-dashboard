...
export default function DashboardChatbot() {
  ...
  return (
    <Card className="dashboard-chatbot-card flex flex-col items-center gap-4 flex-[1_0_0] self-stretch rounded-[10px] bg-white/3 border dark:border-white/4 border-black/15 p-5 overflow-hidden py-5 px-5 h-[550px] md:h-[500px] lg:max-h-[900px] lg:h-[900px]">
