...
export default function DashboardStatus() {
  return (
    <div className="flex flex-col items-start gap-2.5 p-0 sm:p-5 self-stretch rounded-[16px] border-none sm:border border-white/5 bg-transparent sm:bg-popover-gradient backdrop-blur-[0px] sm:backdrop-blur-[7px]">
